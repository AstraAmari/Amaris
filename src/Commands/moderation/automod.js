            ...
            .addFields(
              {
                ...
                value:
                  ...
                  `\`msgspam limit <number>\` - sets the max amount of messages you can send in ${
                    guildSettings?.spamDifference ?? 5
                  } seconds\n` +
                  `\`msgspam difference <number>\` - sets the max amount of seconds you can send ${
                    guildSettings?.spamLimit ?? 5
                  } messages in\n` +
                  `*Current Settings* - (${
                    guildSettings?.spamEnabled ? "enabled" : "disabled"
                  }) ${guildSettings?.spamLimit ?? 5} messages in ${
                    guildSettings?.spamDifference ?? 5
                  } seconds`,
              },
              {
                ...
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.emojiEnabled ? "enabled" : "disabled"
                  }) ${guildSettings?.emojiLimit ?? 5} emojis in one message`,
              },
              {
                ...
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.mentionMemberEnabled ? "enabled" : "disabled"
                  }) ${
                    guildSettings?.mentionUserLimit ?? 5
                  } user mentions in one message`,
              },
              {
                ...
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.mentionRoleEnabled ? "enabled" : "disabled"
                  }) ${
                    guildSettings?.mentionRoleLimit ?? 5
                  } role mentions in one message`,
              },
              {
                name: "Zalgo Text",
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.zalgoEnabled ? "enabled" : "disabled"
                  }) Text | (${
                    guildSettings?.zalgoNicknamesEnabled
                      ? "enabled"
                      : "disabled"
                  }) Nicknames`,
              },
              {
                ...
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.autobanEnabled ? "enabled" : "disabled"
                  }) ${guildSettings?.autobanAge ?? 1} day old`,
              },
              {
                name: "Server Invites",
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.invitesEnabled ? "enabled" : "disabled"
                  })`,
              },
              {
                name: "Caps Lock",
                value:
                  ...
                  `*Current Settings* - (${
                    guildSettings?.capslockEnabled ? "enabled" : "disabled"
                  }) ${guildSettings?.capslockPercentage ?? 75}%`,
              },
              {
            ...
            case "toggle":
              {
                guildSettings?.spamEnabled
                  ...
                  : (guildSettings.spamEnabled = true);
            ...
            case "unignore":
              {
                ...
                if (guildSettings?.spamIgnoredChannels.includes(channelId)) {
                  guildSettings.spamIgnoredChannels =
                    guildSettings?.spamIgnoredChannels.filter(
                      (id) => id != channelId
                    );
                  settings.save(guildSettings);
                  message.reply(
                    `<#${channelId}> has been removed from the list!`
                  );
                } else {
                  if (guildSettings?.spamIgnoredChannels.length >= 30)
                    return message.reply(
                      "You cannot ignore more than 30 channels"
                    );
            ...
            case "limit":
              {
                ...
                if (limit > 100 || limit <= 1)
                  return message.reply(
                    "Limit must be greater than 1 and less than 100"
                  );
                guildSettings.spamLimit = limit;
                settings.save(guildSettings);
                message.reply(
                  `The message spam limit has been set to ${limit} messages in ${
                    guildSettings?.spamDifference ?? 5
                  } seconds`
                );
              }
            ...
            case "diff":
              {
                ...
                if (diff > 60 || diff < 3)
                  return message.reply(
                    "Difference must be greater than 3 and less than 60"
                  );
                guildSettings.spamDifference = diff;
                settings.save(guildSettings);
                message.reply(
                  `The message spam difference has been set to ${
                    guildSettings?.spamLimit ?? 5
                  } messages in ${diff} seconds`
                );
              }
              break;
          }
      ...
      case "espam":
        {
          switch (args[1]) {
                  ...
                  .addFields({
                    ...
                    value:
                      ...
                      `*Current Settings* - (${
                        ...
                        guildSettings?.emojiLimit ?? 5
                      } emojis in one message`,
                  })
                  .setTimestamp();
            ...
            case "toggle":
              {
                guildSettings?.emojiEnabled
                  ? (guildSettings.emojiEnabled = false)
                  : (guildSettings.emojiEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
                    guildSettings?.emojiEnabled ? "enabled" : "disabled"
                  } the emoji spam module`
                );
            ...
            case "unignore":
              {
                ...
                if (guildSettings?.emojiIgnoredChannels.includes(channelId)) {
                  guildSettings.emojiIgnoredChannels =
                    guildSettings?.emojiIgnoredChannels.filter(
                      (id) => id != channelId
                    );
                  settings.save(guildSettings);
                  message.reply(
            ...
            case "limit":
              {
                ...
                if (limit > 1000 || limit <= 1)
                  return message.reply(
                    "Limit must be greater than 1 and less than 1000"
                  );
                guildSettings.emojiLimit = limit;
                settings.save(guildSettings);
                message.reply(
                  `The emoji limit has been set to ${limit} emojis in one message`
                );
              }
              break;
          }
      ...
      case "massmention":
        {
          switch (args[1]) {
                ...
                const mentionMemberHelp = new EmbedBuilder()
                  ...
                  .addFields({
                    ...
                    value:
                      ...
                      "`usermention limit <number>` - sets the max amount of users you can mention in a message\n" +
                      `*Current Settings* - (${
                        guildSettings?.mentionMemberEnabled
                          ? "enabled"
                          : "disabled"
                      }) ${
                        guildSettings?.mentionUserLimit ?? 5
            ...
            case "toggle":
              {
                guildSettings?.mentionMemberEnabled
                  ? (guildSettings.mentionMemberEnabled = false)
                  : (guildSettings.mentionMemberEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
                    guildSettings?.mentionMemberEnabled ? "enabled" : "disabled"
                  } the anti mass user mention module`
                );
            ...
            case "unignore":
              {
                ...
                if (guildSettings?.mentionIgnoredChannels.includes(channelId)) {
                  guildSettings.mentionIgnoredChannels =
                    guildSettings?.mentionIgnoredChannels.filter(
                      (id) => id != channelId
                    );
                  settings.save(guildSettings);
                  message.reply(
            ...
            case "limit":
              {
                ...
                settings.save(guildSettings);
                message.reply(
                  `The user mention limit has been set to ${limit} user mentions in one message`
                );
              }
              break;
          }
      ...
      case "rmention":
        {
          switch (args[1]) {
                ...
                const mentionRoleHelp = new EmbedBuilder()
                  ...
                  .addFields({
                    ...
                    value:
                      ...
                      "`rolemention limit <number>` - sets the max amount of roles you can mention in a message\n" +
                      `*Current Settings* - (${
                        guildSettings?.mentionRoleEnabled
                          ? "enabled"
                          : "disabled"
                      }) ${
                        guildSettings?.mentionRoleLimit ?? 5
            ...
            case "toggle":
              {
                guildSettings?.mentionRoleEnabled
                  ? (guildSettings.mentionRoleEnabled = false)
                  : (guildSettings.mentionRoleEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
                    guildSettings?.mentionRoleEnabled ? "enabled" : "disabled"
                  } the anti mass role mention module`
                );
            ...
            case "limit":
              {
                ...
                settings.save(guildSettings);
                message.reply(
                  `The role mention limit has been set to ${limit} role mentions in one message`
                );
              }
              break;
          }
      ...
      case "zalgo":
        {
          switch (args[1]) {
            ...
            case "toggle":
              {
                guildSettings?.zalgoEnabled
                  ? (guildSettings.zalgoEnabled = false)
                  : (guildSettings.zalgoEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
                    guildSettings?.zalgoEnabled ? "enabled" : "disabled"
                  } the anti zalgo text module`
                );
            ...
            case "nicknames":
              {
                guildSettings?.zalgoNicknamesEnabled
                  ? (guildSettings.zalgoNicknamesEnabled = false)
                  : (guildSettings.zalgoNicknamesEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
                    guildSettings?.zalgoNicknamesEnabled
                      ? "enabled"
                      : "disabled"
                  } the anti zalgo nickname module`
                );
                  ...
                  .setDescription(
                    `You have ${
                      guildSettings?.zalgoNicknamesEnabled
                        ? "enabled"
                        : "disabled"
                    } anti anti zalgo nickname module`
                  )
                  .setTimestamp();
            ...
            case "unignore":
              {
                ...
                if (guildSettings?.zalgoIgnoredChannels.includes(channelId)) {
                  guildSettings.zalgoIgnoredChannels =
                    guildSettings?.zalgoIgnoredChannels.filter(
                      (id) => id != channelId
                    );
                  settings.save(guildSettings);
                  message.reply(
      ...
      case "ban":
        {
          switch (args[1]) {
            ...
            case "toggle":
              {
                guildSettings?.autobanEnabled
                  ? (guildSettings.autobanEnabled = false)
                  : (guildSettings.autobanEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
            ...
            case "age":
              {
                ...
                if (age > 30 || age <= 0)
                  return message.reply(
                    "Age must be greater than 1 and less than 30"
                  );
            ...
            case "unignore":
              {
                ...
                if (guildSettings?.invitesIgnoredChannels.includes(channelId)) {
                  guildSettings.invitesIgnoredChannels =
                    guildSettings?.invitesIgnoredChannels.filter();
                  settings.save(guildSettings);
                  message.reply(
                    `<#${channelId}> has been removed from the list!`
                  );
      ...
      case "caps":
        {
          switch (args[1]) {
            ...
            case "toggle":
              {
                guildSettings?.capslockEnabled
                  ? (guildSettings.capslockEnabled = false)
                  : (guildSettings.capslockEnabled = true);
                settings.save(guildSettings);
                this.client.modLog(
                  message.guild.id,
                  `${message.author} has ${
                    guildSettings?.capslockEnabled ? "enabled" : "disabled"
                  } the anti caps lock module`
                );
                const inviteToggledEmbed = new EmbedBuilder()
                  .setAuthor({
                    name: author.username,
            ...
            case "unignore":
              {
                ...
                if (!guildSettings?.capslockIgnoredChannels)
                  guildSettings.capslockIgnoredChannels = [];
                if (
                  guildSettings?.capslockIgnoredChannels.includes(channelId)
                ) {
                  guildSettings.capslockIgnoredChannels =
                    guildSettings?.capslockIgnoredChannels.filter(
                      (id) => id != channelId
                    );
                  settings.save(guildSettings);
                  message.reply(
            ...
            case "percent":
              {
                ...
                if (percent > 100 || percent < 50)
                  return message.reply(
                    "Percentage must be greater than 50 and less than 100"
                  );
                guildSettings.capslockPercentage = percent;
                settings.save(guildSettings);
                message.reply(
                  `A message now must contain ${percent}% caps lock for it to be deleted`
                );
              }
              break;
          }
